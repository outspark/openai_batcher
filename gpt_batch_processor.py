...
# def process_csv_to_text(file_obj, remove_list):
...
# def create_jsonl_from_csvs(csv_files, remove_list, output_jsonl, prompt="default prompt"):
#     with open(output_jsonl, 'w') as outfile:
#         for idx, file_obj in enumerate(csv_files):
#             file_obj.seek(0)  # Reset file pointer to the beginning

#             csv_text = process_csv_to_text(file_obj, remove_list)
